...
impl Cpu {
    ...
    if _posedge_clock {
        ...
        println!("{:>4}ns PC={:04x} IR={:04x}, SW={:04x}, A={}", self.sim_time as u64, bus_to_u16(&self.pc0) as u64, bus_to_u16(&self.i_r) as u64, bus_to_u16(&self.s_w) as u64, bus_to_u16(&self.a) as u64);
    }
    }
    pub fn run(&mut self) {
        ...
        while if (self.i as u64) < (32) { 1 } else { 0 } != 0 {
            println!("{:04x}: {:04x}", self.i as u64, (((bus_to_u16(&self.m[(((self.i as u64) + (1)) & 65535u64) as usize]) as u64) & 255u64) << 0) | (((bus_to_u16(&self.m[(self.i as u64) as usize]) as u64) & 255u64) << 8));
